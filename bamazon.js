...
connection.connect(function(err) {
  if (err) throw err;
  console.log(
    "\nWelcome to BAmazon! our products for sale below!\n"
  );
    ...
    .then(function(answer) {
      ...
      connection.query(queryProducts, { item_id: product }, function(err, res) {
        ...
        if (quantity > productInfo.stock_quantity) {
          ...
          console.log(
            "I'm sorry we don't have enough in stock, choose a smaller quantity!"
          );
          console.log(
            "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n"
          );
          ...
          connection.query(
            queryUpdate,
            [{ stock_quantity: answer.quantity }, { item_id: product }],
            function(err, res) {
              if (err) throw err;
              else {
                console.log(
